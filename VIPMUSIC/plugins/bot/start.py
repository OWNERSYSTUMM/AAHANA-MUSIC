...
"""
        ...
        try:
            ...
            await vip.edit_text(f"**𝗘**")
            await vip.edit_text(f"**𝗟**")
            await vip.edit_text(f"**𝗖**")
            await vip.edit_text(f"**𝗢**")
            await vip.edit_text(f"**𝗠𝗘**")

            await vip.delete()
            vips = await message.reply_text("**𝗧𝗛**")
            await asyncio.sleep(0.1)
            await vips.edit_text("**𝗔𝗡**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗞𝗦**")
            #  await asyncio.sleep(0.1)
            await vips.edit_text("**𝗙𝗢**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗥**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗦𝗧**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗔𝗥**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗧𝗜**")
            # await asyncio.sleep(0.1)
            await vips.edit_text("**𝗡𝗚.**")
            await asyncio.sleep(0.1)
